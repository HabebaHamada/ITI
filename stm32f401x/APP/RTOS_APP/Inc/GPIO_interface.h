...
void GPIO_SetPinMode(u8 Copy_u8Port,
		             u8 Copy_u8Pin ,
					 u8 Copy_u8Mode );

void GPIO_SetPinOutputType(u8 Copy_u8Port,
                           u8 Copy_u8Pin ,
	                       u8 Copy_u8OutputType );


void GPIO_SetPinOutputSpeed(u8 Copy_u8Port,
                            u8 Copy_u8Pin ,
		                    u8 Copy_u8OutputSpeed );


void GPIO_SetPinInputPull(u8 Copy_u8Port,
                          u8 Copy_u8Pin ,
                          u8 Copy_u8PullType );

void GPIO_SetAlternativeFunction(u8 Copy_u8Port,
		                          u8 Copy_u8Pin,
								  u8 Copy_u8AlternateFunction);
